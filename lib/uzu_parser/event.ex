defmodule UzuParser.Event do
  ...
  ## Examples
      ...
      %Event{sound: "bd", time: 0.0, duration: 0.25, params: %{}}

      # Snare at beat 2 with volume
      %Event{sound: "sd", time: 0.5, duration: 0.25, params: %{gain: 0.8}}
  """
  ...
  ## Examples
      ...
      %Event{sound: "bd", time: 0.0, duration: 1.0, params: %{}}

      iex> Event.new("sd", 0.5, duration: 0.25, params: %{gain: 0.8})
      %Event{sound: "sd", time: 0.5, duration: 0.25, params: %{gain: 0.8}}
  """
